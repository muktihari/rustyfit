...
impl MesgCapabilities {
    ...
    /// Value's type: `u8`; FitBaseType::ENUM; ProfileType::MesgCount
...
#[cfg(feature = "serde")]
impl Serialize for MesgCapabilities {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        let n = self.count_valid_fields() + 2;
        let mut state = serializer.serialize_struct("MesgCapabilities", n)?;
        ...
        if self.count_type.0 != u8::MAX {
            state.serialize_field("count_type", &self.count_type)?;
        }
...
#[cfg(feature = "serde")]
impl From<De> for MesgCapabilities {
    fn from(m: De) -> Self {
        Self {
